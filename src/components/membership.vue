...
<template>
  <div>
    <header>
      <q-card flat square class="custom__header-bg-v2 row items-center">
    ...
    <section class="q-mt-lg">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 q-px-lg q-py-md">
          ...
          <!-- <q-card flat square class="bg-white">
            <img alt="affilate" src="/images/affilate.jpg" />
          </q-card> -->
        </div>
      </div>
      <div class="row">
        <div class="col">
          <q-card flat square class="bg-white">
            <img alt="executive" src="/images/group1.jpg" />
          </q-card>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 col-sm-12 col-xs-12 q-px-lg q-py-md">
          ...
          >
            ...
            Honorary Membership into the Association. An Honorary Member shall
        ...
        <div class="bg-grey-10 q-pa-xl">
          ...
          >
            <div class="col-md-8 col-sm-12 col-xs-12">
              ...
              <p
                class="text-white my-font-poppins-bold gt-sm"
        ...
        <div class="col-md-8 col-sm-12 col-xs-12 q-px-lg q-py-md">
          <q-list class="bg-grey-1">
            <q-expansion-item
              expand-icon="add"
              group="somegroup"
              label="1. Why Choose NABG?"
              header-class="text-grey-10 text-body1 my-font-poppins-bold"
            >
              <q-card>
                <q-card-section
            ...
            <q-expansion-item
              expand-icon="add"
              group="somegroup"
              label="2. What can NABG do for you?"
              header-class="text-grey-10 text-body1 my-font-poppins-bold"
            >
              <q-card>
                <q-card-section
            ...
            <q-expansion-item
              expand-icon="add"
              group="somegroup"
              label="3. How do i become a member?"
              header-class="text-grey-10 text-body1 my-font-poppins-bold"
            >
              <q-card>
                <q-card-section
            ...
            <q-expansion-item
              expand-icon="add"
              group="somegroup"
              label="4. Where is NABG Headquaters located?"
              header-class="text-grey-10 text-body1 my-font-poppins-bold"
            >
              <q-card>
                <q-card-section
            ...
            <q-expansion-item
              expand-icon="add"
              group="somegroup"
              label="5. What is NABG really all about?"
              header-class="text-grey-10 text-body1 my-font-poppins-bold"
            >
              <q-card>
                <q-card-section
            ...
            <q-expansion-item
              expand-icon="add"
              group="somegroup"
              label="6. Is NABG into other businesses other than agribusinesses?"
              header-class="text-grey-10 text-body1 my-font-poppins-bold"
            >
              <q-card>
                <q-card-section
            ...
            <q-expansion-item
              expand-icon="add"
              group="somegroup"
              label="7. Does NABG have members from rural communities?"
              header-class="text-grey-10 text-body1 my-font-poppins-bold"
            >
              <q-card>
                <q-card-section
            ...
            <q-expansion-item
              expand-icon="add"
              group="somegroup"
              label="8. I am new to agribusinesses, can i still join NABG?"
              header-class="text-grey-10 text-body1 my-font-poppins-bold"
            >
              <q-card>
                <q-card-section
